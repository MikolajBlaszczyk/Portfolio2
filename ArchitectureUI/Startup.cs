...
namespace ArchitectureUI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IStairs, Stairs>();
            services.AddScoped<ISingleComposition, SingleComposition>();
            services.AddScoped<IMultiComposition, MultiComposition>();
            services.AddScoped<ISingleComposition, SingleComposition>();
            services.AddScoped<IMaxHeight, MaxHeight>();
